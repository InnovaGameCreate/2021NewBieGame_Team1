...
public class Zyanken : MonoBehaviour
{
    ...
    private bool one; //Ç∂Ç·ÇÒÇØÇÒÇàÍâÒÇÃÇ›çsÇ§
    ...
    void Update()
    {
        ...
        if (hand != 0)
        {
            ...
            {
                hand = 0;
                StartCoroutine("Drow");//â∫ÇÃWinÇå©ÇƒÇ≠ÇÍ
                one = false;
            ...
            {
                hand = 0;
                StartCoroutine("Drow");//â∫ÇÃLoseÇå©ÇƒÇ≠ÇÍ
                one = false;
                audioSource.PlayOneShot(sound1);
            }
            ...
            {
                hand = 0;
                StartCoroutine("Win");//â∫ÇÃLoseÇå©ÇƒÇ≠ÇÍ
                one = false;
                audioSource.PlayOneShot(sound1);
            }
